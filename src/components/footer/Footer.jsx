  ...
  return (
    ...
    <div className="md:w-[334px] md:hidden">
      ...
      <div className=" py-[10px] md:py-[43px] bg-[#282828]">
       <Container>
         <p className="font-primary text-[14px] md:text-[16px] md:font-medium text-[#6C6C6C] text-center md:text-left">&copy; Copyright 2024 by AltDesain Studio - All right reserved.</p>
       </Container>
      </div>
    </footer>
  );
